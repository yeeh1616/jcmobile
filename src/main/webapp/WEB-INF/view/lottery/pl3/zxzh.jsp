...
$(this).toggleClass("active"); return true; 
 ...
 <div data-role="page" id="betPanelId">
  <div data-role="header" data-position="fixed"  data-tap-toggle="false" data-id="top" >
    <h1><a href="javascript:;" class="btn-slide active">直选组合</a></h1>
    ...
    <div data-role="navbar">
      <ul>
        <li><a data-ajax="false" href="/lottery/index.jhtml?licenseId=${licenseId }" <c:if test="${pl3SubPlayName == 'pt' }">class="ui-btn-active ui-state-persist"</c:if> data-transition="none">普通投注</a></li>
        <li><a data-ajax="false" href="/lottery/index.jhtml?licenseId=${licenseId }&p=zxzh" <c:if test="${pl3SubPlayName == 'zh' }">class="ui-btn-active ui-state-persist"</c:if> data-transition="none" >组合复式</a></li>
        <li><a data-ajax="false" href="/lottery/index.jhtml?licenseId=${licenseId }&p=zxhz" <c:if test="${pl3SubPlayName == 'hz' }">class="ui-btn-active ui-state-persist"</c:if> data-transition="none" >和值投注</a></li>
      </ul>
    </div>
  </div>
  <!-- /header --> 
  ...
  <div data-role="content" class="wrapper_navbar2">
	...
	<div class="con_top_p2">至少选择3个号码</div>
      <div class="clear"></div>
    </div>
    <div class="con_1">
      <div class="con_con">
