...
$(this).toggleClass("active"); return true; 
 ...
 <div data-role="page" id="betPanelId">
  <div data-role="header" data-position="fixed"  data-tap-toggle="false" data-id="top" >
    <h1><a href="javascript:;" class="btn-slide active">组六</a></h1>
    ...
    <div data-role="navbar">
      <ul>
        <li><a data-ajax="false" href="/lottery/index.jhtml?licenseId=${licenseId }&p=z6pt" <c:if test="${pl3SubPlayName == 'pt' }">class="ui-btn-active ui-state-persist"</c:if> data-transition="none" >复式投注</a></li>
        <li><a data-ajax="false" href="/lottery/index.jhtml?licenseId=${licenseId }&p=z6hz" <c:if test="${pl3SubPlayName == 'hz' }">class="ui-btn-active ui-state-persist"</c:if> data-transition="none" >和值投注</a></li>
      </ul>
    </div>
  </div>
  <!-- /header --> 
