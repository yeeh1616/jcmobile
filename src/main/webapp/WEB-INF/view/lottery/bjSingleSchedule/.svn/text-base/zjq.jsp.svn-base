...
<body>
<!--------------过关投注--------------------->
<div data-role="page" id="betPanelId" class="ui-page ui-page-theme-a ui-page-header-fixed ui-page-footer-fixed ui-page-active" style="padding-top: 43px; padding-bottom: 50px;"> 
  ...
  <div data-role="header" data-position="fixed" data-tap-toggle="false" data-id="top">
    ...
    <div class="head-left"><a href="/?mfrom=${mfrom }&storeId=${domain.storeId}" class="qx-icon" data-transition="slide" data-ajax="false" data-direction="reverse" >返回</a> </div>
