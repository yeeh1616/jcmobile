...
<div data-role="page" id="betPanelId"> 
  ...
  <div data-role="header" data-position="fixed" data-tap-toggle="false" data-id="top">
    <h1 ><a href="javascript:;" class="btn-slide active">上下单双</a></h1>
    <jsp:include page="./header.jsp"></jsp:include>
    <div class="head-left"><a href="/?mfrom=${mfrom }&storeId=${domain.storeId}" class="qx-icon" data-transition="slide" data-direction="reverse" data-ajax="false">返回</a> </div>
  ...
  <div data-role="content" style=" padding:0;">
    ...
    <ul id="betUlList" class="zulan tou_zu sxsd">
