 ...
 <div data-role="page" id="betPanelId">
  <div data-role="header" data-position="fixed"  data-tap-toggle="false" data-id="top" >
    ...
    <div data-role="navbar">
      <ul>
        <li>
        <a data-ajax="false" href="/lottery/index.jhtml?licenseId=${licenseId }&p=r7pt" <c:if test="${freqSubPlayName == 'pt' }">class="ui-btn-active ui-state-persist"</c:if> data-transition="none">任选七</a>
        </li>
        <li>
        <a data-ajax="false" href="/lottery/index.jhtml?licenseId=${licenseId }&p=r7dt" <c:if test="${freqSubPlayName == 'dt' }">class="ui-btn-active ui-state-persist"</c:if> data-transition="none">任七胆拖</a>
        </li>
