...
<html> 
<head>
<title>${domain.storeName}-双色球</title>
...
$(this).toggleClass("active"); return true; 
 ...
 <div data-role="page" id="betPanelId">
  <div data-role="header" data-position="fixed"  data-tap-toggle="false" data-id="top" >
    <h1><a href="javascript:;" class="btn-slide active">双色球胆拖</a></h1>
    <div style="display: none;" id="panel">
      <ul>
        <li <c:if test="${p == 'ssq' }">class="xz"</c:if>><a data-ajax="false" href="/lottery/index.jhtml?licenseId=11">普通投注</a></li>
        <li <c:if test="${p == 'ssqdt' }">class="xz"</c:if>><a data-ajax="false" href="/lottery/index.jhtml?licenseId=11&p=ssqdt">胆拖投注</a></li>
        <div class=" clear"></div>
      </ul>
    </div>
  ...
  <div data-role="content" id="wrapper">
    ...
    <div class="con_top">
      ...
      <div class="con_top_p2">至少选择7个球,1个胆</div>
      <div class="clear"></div>
    </div>
    <!--红球区域 -->
