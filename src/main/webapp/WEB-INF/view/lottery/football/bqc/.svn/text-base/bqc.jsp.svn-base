 ...
 <div data-role="page" id="betPanelId">
  ...
  <div data-role="content" style="padding-top:0" id="wrapper">
    <div class="con_top">
      ...
      <div class="con_top_p2">选择半场全场胜平负</div>
      <div class="clear"></div>
    </div>
  ...
  <div id='divze' class="ze">
    ...
    <script type="text/javascript" src="http://101.200.213.247:9380/global/schudle/7/${game.issue }.js?time=new Date().getTime()"></script>
