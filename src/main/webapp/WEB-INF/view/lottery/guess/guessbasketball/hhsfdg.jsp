...
<title>${domain.storeName }-单关投注 </title>
...
<div data-role="page" id="betPanelId"> 
  ...
  <div data-role="header" data-position="fixed" data-tap-toggle="false" data-id="top">
    ...
    <div data-role="navbar">
      <ul>
        <li><a data-ajax="false" href="/lottery/index.jhtml?licenseId=${licenseId }&p=hhsfdg" <c:if test="${p == 'hhsfdg' }">class="ui-btn-active ui-state-persist"</c:if> data-transition="none">胜负/让分胜负</a></li>
...
<jsp:include page="../guessfootball/dgfooter.jsp"></jsp:include>
</body>
</html>