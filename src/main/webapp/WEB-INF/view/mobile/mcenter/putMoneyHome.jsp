...
<div data-role="page" id="card">
  ...
  <div data-role="content" class="common-icon" style="padding-left:0;padding-right:0">
      ...
      <li>
      <a <c:choose>
	  <c:when test="${sftKey eq '1'}">href="/wap/recharge/putMoneyYHK.wap"</c:when>
	  <c:otherwise>onclick="alert('该店铺暂不支持盛付通充值');"</c:otherwise>
	  </c:choose> data-ajax="false">
      <img src="/mobile/images/yhk-icon.png">
        <h2>储蓄卡充值</h2>
        <p>支持多家银行快速充值</p>
        </a> </li>
    </ul>
    ...
    <ul data-role="listview" data-inset="true">
      <li> <a href="#"> <img src="/mobile/images/zfb_icon.png">
        <h2>支付宝充值</h2>
        <p>无手续费，充值立即到账</p>
        </a> </li>
    </ul>
     -->
     <ul data-role="listview" data-inset="true">
      <li> <a href="/wap/putMoneyZZ.wap"> <img src="/mobile/images/zhuanzhang.png"/>
        <h2>转账充值</h2>
        <p>最传统的充值方式</p>
        </a> </li>
    </ul>
