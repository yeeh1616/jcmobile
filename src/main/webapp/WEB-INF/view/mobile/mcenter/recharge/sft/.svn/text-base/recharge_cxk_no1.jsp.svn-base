...
<script type="text/javascript" src="/mobile/js/usercenter/recharge/sft/recharge.js"></script>
  ...
  <ul class="ui-grid-c">
     <li style="width:50% !important;float:left;line-height:28px;">
     	<a class="ui-btn-active ui-state-persist ui-link ui-btn" data-transition="none" style="padding-top:9px !important;padding-bottom:9px !important;">储蓄卡</a>
     </li>
     <li style="width:50% !important;float:left;line-height:35px important;">
     	<a data-ajax="false" href="/wap/recharge/rechargeNo1.wap?type=CR" data-transition="none" class="ui-link ui-btn" style="padding-top:9px !important;padding-bottom:9px !important;">信用卡</a>
     </li>
  </ul>
  ...
  <div data-role="content" style="padding-top:0;">
    <div class="jine">
     <input type="hidden" id="cardType" value="DR" />
