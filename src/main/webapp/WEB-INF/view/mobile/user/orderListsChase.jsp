		...
		<div data-role="page" id="part2" class="order_lists">
			<div data-role="header" data-position="fixed" data-tap-toggle="false" id="top">
				...
				<div data-role="navbar">
					<ul>
						...
						<li><a href="#" class="ui-btn-active ui-state-persist">追号记录</a></li>
			...
			<div id="wrapper_isroll" data-role="content">
				<div id="scroller">
					...
					<ul id="list-chase"  style="padding:1em; padding-top:0em" class="ui-listview ui-listview-inset ui-corner-all ui-shadow">
					</ul>
					<!--未开奖状态 -->
					<div id="pullup">
