...
<div data-role="page" id="part1" class="order_lists">
	    <div data-role="header" data-position="fixed" data-tap-toggle="false" id="top">
		    <div class="head-left"><a onclick="gotoa('/wap/mcenter.wap')"  data-ajax="false" class="qx-icon" data-transition="slide" data-direction="reverse" >用户中心</a></div>
		    ...
		    <div data-role="navbar">
		          <ul>
		        <li><a href="#" class="ui-btn-active ui-state-persist" data-transition="none">全部投注</a></li>
	     ...
	     <div id="scroller"> 
	       ...
	       <ul  data-role="listview" data-inset="true" id="list-all" >
