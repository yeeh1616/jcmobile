...
<html>
  <body>
  	...
  	<script type="text/javascript">
        function pload_pass() { setTimeout("location.href='/wap/safe.wap'", 3000); }
        pload_pass();
    </script>
    <!-- Index Page -->
    <div data-role="page">
...
padding-bottom: 2.5em;">
            ...
            <div class="success_txt">
                <div>您已成功设置交易密码！</div>
                <div class="tz">如果页面没有跳转,请点击<a data-transition="slide" rel="external" href="/wap/safe.wap">返回安全中心</a></div>
                <div class="tz red">正在为您转到安全中心,请稍后..</div>
            </div>
            <div class="clear"></div>
        </div>
        <!-- /content -->
