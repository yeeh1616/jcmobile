...
<html>
  <body>
    ...
    <!-- 账户明细 -------------------------------------------------------------------->
    <div data-role="page" id="part3" class="order_lists">
        <div data-role="header" data-position="fixed" data-tap-toggle="false" id="top">
            ...
            <div data-role="navbar">
                <ul>
                    ...
                    <li><a onclick="goToQukuanjilu()" data-transition="none">取款记录</a></li>
                    <li><a onclick="goToZhanghumingxi()" class="ui-btn-active ui-state-persist" data-transition="none">账户明细</a></li>
        ...
        <div data-role="content" style="padding:0">
            <div id="wrapper_isroll">
                <div id="scroller">
                    <div id="pulldown"> <span class="pulldown-icon"></span><span id="pulldown-label"></span> </div>
                    <ul id="ulAccountDetail" data-role="listview" data-inset="true" class="funds">
                        <!--取款记录-->
                        <!--取款记录 end -->
                    </ul>
                    <div id="pullup"> <span class="pullup-icon"></span><span id="pullup-label"></span> </div>
                    <div style="height:30px;"></div>
                </div>
            </div>
            <div class="clear"><span id="spPage_detail" style="display:none;"></span></div>
        </div>
        <!-- /content -->
    </div>
