...
<html>
  <body>
    ...
    <!-- 欠款单 -------------------------------------------------------------------->
    <div data-role="page" id="part4" class="order_lists">
        <div data-role="header" data-position="fixed" data-tap-toggle="false" id="top">
            ...
            <div data-role="navbar">
                <ul>
                    ...
                    <li><a onclick="goToQiankuandan()" class="ui-btn-active ui-state-persist" data-transition="none">欠款单</a></li>
                </ul>
            </div>
        </div>
        <!-- /header -->
        ...
        <div data-role="content" style="padding:0">
            <div id="wrapper_isroll">
                <div id="scroller">
                    ...
                    <ul id="ulDebit" data-role="listview" data-inset="true" class="funds">
                        <!--取款记录-->
                        <!--取款记录 end -->
                    </ul>
            ...
            <div class="clear"><span id="spPage_debit" style="display:none;"></span></div>
        </div>
        <!-- /content -->
    </div>-->
</body>
