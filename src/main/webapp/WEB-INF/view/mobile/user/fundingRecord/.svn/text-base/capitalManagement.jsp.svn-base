...
<html>
  <body>
    ...
    <!-- 充值记录 -------------------------------------------------------------------->
    <div data-role="page" id="part1" class="order_lists">
        <div data-role="header" data-position="fixed" data-tap-toggle="false" id="top">
            ...
            <div data-role="navbar">
                <ul>
                    <li><a onclick="goToCapitalManagement()" class="ui-btn-active ui-state-persist" data-transition="none">充值记录</a></li>
        ...
        <div data-role="content" style="padding:0">
            <div id="wrapper_isroll">
                <div id="scroller">
                    ...
                    <ul id="ulRechargeHistory" data-role="listview" data-inset="true" class="funds">
                        <!--未开奖状态 -->
                        <!--充值记录-->
                        <!--充值记录 end -->
                    </ul>
