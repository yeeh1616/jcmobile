...
padding-bottom: 2.5em;">
    ...
    <div class="success_txt">
      <div>您已成功发起方案<br/>
                 总金额<span id="spanMoney">${order.betPrice }</span>元，
                 您支付<b><font color=red> ${order.reserved20 }</font></b> 元</div>
      <div class="tz">点击查看<a data-transition="slide" rel="external"  data-ajax="false"  href="/wap/mergerJoinList.wap">购彩记录</a>,或返回<a data-transition="slide" data-ajax="false"  href="/?mfrom=${mfrom }&storeId=${domain.storeId}">购彩大厅</a></div>
    </div>
    <div class="clear"></div>
  </div>
  <!-- /content --> 
