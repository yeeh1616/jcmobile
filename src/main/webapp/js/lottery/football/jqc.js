...
$(document).ready(function () {
	...
	$(".cp_button .jx").click(function(){
		var code = "", t = "";
		for ( var i = 0; i < 8; i++ ) {
			var r = RADOM_INDEX[football.random(4)];
			code += r + ",";
			t += '<span>'+r+"</span>";
		}
		code = code.substring(0, code.length-1);
...
function radomOne() {
	$("a.active").removeClass("active");
	$("#wrapper").find(".ui-controlgroup-controls").each(function(index){
		var bet = RADOM_INDEX[football.random(4)];
...
function loadSch() {
	...
	for ( var i = 0; i < schedules.length; i++ ) {
		html += '<div class="sf_list">      <div class="zhu_team">主</div>'+
			      ...
			      '<div class="banq">主队(进球数)</div>'+
			      '<div data-role="controlgroup" data-type="horizontal" class="spf ui-controlgroup ui-controlgroup-horizontal ui-corner-all"><div class="ui-controlgroup-controls "> <a href="#" class="ui-link ui-btn ui-shadow ui-corner-all ui-first-child" data-role="button" bet="0">0</a> <a href="#" class="ui-link ui-btn ui-shadow ui-corner-all" data-role="button" bet="1">1</a><a href="#" class="ui-link ui-btn ui-shadow ui-corner-all" data-role="button" bet="2">2</a> <a href="#" class="ui-link ui-btn ui-shadow ui-corner-all ui-last-child" data-role="button" bet="3">3+</a> </div></div>'+
			      '<div class="banq">客队(进球数)</div>'+
			    '<div data-role="controlgroup" data-type="horizontal" class="spf ui-controlgroup ui-controlgroup-horizontal ui-corner-all"><div class="ui-controlgroup-controls "> <a href="#" class="ui-link ui-btn ui-shadow ui-corner-all ui-first-child" data-role="button" bet="0">0</a> <a href="#" class="ui-link ui-btn ui-shadow ui-corner-all"  data-role="button" bet="1">1</a><a href="#" class="ui-link ui-btn ui-shadow ui-corner-all"  data-role="button" bet="2">2</a> <a href="#" class="ui-link ui-btn ui-shadow ui-corner-all ui-last-child" data-role="button" bet="3">3+</a> </div></div>'+
			    '</div>';
	}
