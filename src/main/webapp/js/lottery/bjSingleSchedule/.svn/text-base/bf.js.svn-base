...
JCZQ_INDEX_BF.put("9A", "胜其他");
JCZQ_INDEX_BF.put("10", "1:0");
JCZQ_INDEX_BF.put("20", "2:0");
JCZQ_INDEX_BF.put("21", "2:1");
JCZQ_INDEX_BF.put("30", "3:0");
JCZQ_INDEX_BF.put("31", "3:1");
JCZQ_INDEX_BF.put("32", "3:2");
JCZQ_INDEX_BF.put("40", "4:0");
JCZQ_INDEX_BF.put("41", "4:1");
JCZQ_INDEX_BF.put("42", "4:2");
JCZQ_INDEX_BF.put("99", "平其他");
JCZQ_INDEX_BF.put("00", "0:0");
JCZQ_INDEX_BF.put("11", "1:1");
JCZQ_INDEX_BF.put("22", "2:2");
JCZQ_INDEX_BF.put("33", "3:3");
JCZQ_INDEX_BF.put("0A", "负其他");
JCZQ_INDEX_BF.put("01", "0:1");
JCZQ_INDEX_BF.put("02", "0:2");
JCZQ_INDEX_BF.put("12", "1:2");
JCZQ_INDEX_BF.put("03", "0:3");
JCZQ_INDEX_BF.put("13", "1:3");
JCZQ_INDEX_BF.put("23", "2:3");
JCZQ_INDEX_BF.put("04", "0:4");
JCZQ_INDEX_BF.put("14", "1:4");
JCZQ_INDEX_BF.put("24", "2:4");
$(document).ready(function () {
	...
	$("a[name=betN]").click(function(){
		...
		for ( var i = 0; i < 25; i++ ) {
			$(betNs[i]).children().eq(0).children().eq(1).html(odds[i]);
		}
	...
	for ( var i = 0; i < schedules.length; i++ ) {
		...
		if ( date == obj.uuid.substring(0,8) ) {
			html += '<li id="'+obj.uuid+'" host="'+obj.hostTeam+'" guest="'+obj.guestTeam+'" betlen="0" bet="">'+
				        ...
				        '<div>'+
				        '<a  href="#sfc" data-rel="popup" data-transition="slide" odd="'+obj.bfOdds+'" name="betN" v="'+obj.uuid+'">点击展开投注区</a>'+
				        '</div>'+
				        '</div>'+
				        '</div>'+
				        '<div class="clear"></div>'+
			...
			html += '<h1>'+date.substring(4, 6)+'月'+date.substring(6)+'日 '+dateUtils.getWeekDay(dd)+' '+(counterMap.get(date)=='undefined'?'0':counterMap.get(date))+'场比赛可投注</h1>';
		        ...
		        '<div class="bottom_all">'+
		        '<div>'+
		        '<a  href="#sfc" data-rel="popup" data-transition="slide" odd="'+obj.bqcggodds+'" name="betN" v="'+obj.uuid+'">点击展开投注区</a>'+
		        '</div>'+
		        '</div>'+
		        '</div>'+
		        '<div class="clear"></div>'+
