		...
		if ( date == obj.uuid.substring(0,8) ) {
			html += '<li id="'+obj.uuid+'" host="'+obj.hostTeam+'" guest="'+obj.guestTeam+'">'+
				        '<div class="part1">'+
				          ...
				          '<div class="zul_txt"><span>'+obj.uuid.substring(8)+'</span> <span>'+getAheadTime(obj.betEndTime.substring(11,16))+'</span></div>'+
				        '</div>'+
				        '<div class="zu_r">'+
				        '<div class="part2 none_linh" bet="3" betName="主胜">'+
				        '<a href="javascript:void 0">'+
				          '<div class="zul_txt">'+obj.hostTeam+'<span class="red"> '+obj.rq+'</span></div>'+
				        ...
				        '<a href="javascript:void 0" >'+
				          '<div class="zul_txt">'+obj.guestTeam+'</div>'+
