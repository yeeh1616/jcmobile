...
$(document).ready(function () {
	...
	var html = '';
	for ( var i = 0; i < 10; i++ ) {
		html += '<li v='+i+'><a href="#">'+i+'</a><p>'+z6PtOmit[0].dmos[i].omit+'</p> </li>';
	}
	...
	$("#qrBtnId").click(function(){
		...
		if ( counter < 3 ) {
			...
			// 填充投注数据
			var betNum = combAlg.calcCombNum(counter,3);
			var t = "", code = "";
...
function calc() {
	...
	var betNum = 0;
	if ( counter >= 3 ) {
		betNum = combAlg.calcCombNum(counter,3);
	}
