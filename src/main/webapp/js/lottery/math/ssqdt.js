...
$(document).ready(function () {
	...
	$("#beforeAreaId li").click(function(){
		if ( $(this).hasClass("ball_active") && $(this).hasClass("dan_txt") ) {
			...
			if ( $("#beforeAreaId li.dan_txt").length == 5 ) {
				alert("前区最多设5个胆！");
				return false;
			}
	...
	$("#qrBtnId").click(function(){
		...
		if ( before > 6 && after >= 1 ) {
			...
			before = before - bdan;
			after = after - adan;
			betNum = combAlg.calcCombNum(before,6-bdan) * combAlg.calcCombNum(after,1);
